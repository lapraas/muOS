...
from dubious.raw import RawApplication, RawHello, RawReady, RawSnowflake, RawUnavailableGuild, RawUser
...
class Client:
    ...
    async def onHello(self, payload: RawHello):
    ...
    async def onReady(self, payload: RawReady):
