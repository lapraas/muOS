...
SCENE = Cmd(
    "scene",
    f"""
        This command provides a standardized way to break / pause / resume scenes. React to messages created by this command with ❌ to clear them, ⏸ to change their text to signify a scene pause, and ▶️ to send a new message signifying a scene resume.
    """,
    usage=[
        "pause",
        "hold",
